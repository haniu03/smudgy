...
preferences-bold-is-bright = Жирний текст термінала
preferences-bold-is-bright-help = Виберіть, чи жирний SGR-текст використовує більшу насиченість шрифту, яскраву палітру ANSI чи обидва варіанти. Явні коди яскравих кольорів залишаються яскравими в кожному режимі.
