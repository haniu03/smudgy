...
preferences-theme-extended-colors = Пристосовувати коди truecolor та 256-кольорові коди до кольорів теми.
preferences-theme-extended-colors-help = Якщо цю опцію вимкнено, 256-кольорові коди та коди truecolor відображаються точно, через що темніший текст може бути важко читати в темах без суцільного чорного тла
