...
preferences-bold-is-bright-help = Виберіть, чи жирний SGR-текст використовує більшу товщину шрифту, яскраву палітру ANSI або обидва варіанти. Явні коди яскравих кольорів залишаються яскравими в кожному режимі.
